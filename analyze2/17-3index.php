...
<div id="hero" class="full-w">
  <div> <span style="color: rgb(17, 124, 205); white-space: nowrap; text-decoration: none; text-transform: uppercase; font-size: 32px; font-weight: normal;">Our Local SEO Solution</span>
...
<div id="act-boxes" class="cont-w" style="height: 225px;">
  ...
  <div class="shade second col span_1_of_3"> <img src="img/grid2.png">
    ...
    <a href="comingsoon.php">Analyze</a> </div>
