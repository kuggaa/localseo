...
<a href="#mobileClass" id="anchor">.</a>
        <div id="container">
            ...
            <div id="thankyou" class="cont-w">
                <div>
                    <h2 style="text-align: center; margin-top: 55px ! important;">Thank You for the Submission. One of our team member will contact you shortly.</h2>
                 </div>
            </div>
